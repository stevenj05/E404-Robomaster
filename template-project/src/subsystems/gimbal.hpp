...
private:
    ...
    static constexpr float BEYBLADE_KD_RATE    = 160.0f;
    static constexpr float BEYBLADE_KP_HEADING = 200.0f;
    ...
    static constexpr float BEYBLADE_USER_ACCEL    = 101.0f;  // 40 * (48/19) for 19:48 sprocket ratio
    ...
    static constexpr float BEYBLADE_HOLD_DAMP = 1.98f;    // 5 * (19/48): shaft spins 2.53x faster per turret degree
    ...
    // Motor constants
    static constexpr int MAX_GIMBAL_RPM = 4000;  // Increased from 500 to match higher motor output capacity
